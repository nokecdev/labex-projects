...
# Prompts the user to enter the command or script to be executed, the scheduled time
# Then sets the cron schedule based on the chosen schedule.
# Finally it sets to the crontab -l command
add_task() {
    read -p "Enter the command or script to the executed: " command
    ...
    case $schedule in
      ...
      weekly)
        ...
        ;;
      *)
        echo "Invalid schedule. Please choose hourly, weekly, or daily."
        return
        ;;
    esac
